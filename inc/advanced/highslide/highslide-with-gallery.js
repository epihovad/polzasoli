...
lang : {
	...
	loadingTitle : 'Кликните для выхода',
	...
	restoreTitle : 'Кликните чтобы закрыть изображение, нажмите и перетащите изображение.'
},
...
/* ------------------------------------ ВИД 1 ---------------------------------- */
hs.graphicsDir = '/inc/advanced/highslide/graphics/';
hs.align = 'center';
