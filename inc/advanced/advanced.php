...
function aInput($type, $properties, $value="", $spec="") // "тип" поля ввода, свойства поля, значение, переменная для конкректного типа
{
	...
	switch(strtolower($type))
	{
      ...
      <center>
      <div class="arrnum">
      	<div class="more" title="+1"></div><div class="less" title="-1"></div>
      	<input type="text" <?=$properties?> class="arrnum" value="<?=$value?>" maxlength="2">
      </div>
      </center>
			<?
			break;
...
function showFck($name,$text,$toolBar='full',$width="100%",$rows=20)
{	
