  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="23" style="background-image:url(img/head.gif); background-repeat:repeat-x;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td nowrap style="padding-left:10px;color:#697079;" width="270">
              <b><a href="/" target="_blank" title="переход на сайт (откроется в новом окне)"><?=$_SERVER['SERVER_NAME']?></a> - Администрирование</b>
            </td>
            <td nowrap align="center" style="color:#697079;font:normal 12px Tahoma, Geneva, sans-serif;">
							<?=show_hot_statistic()?>
            </td>
            <td nowrap width="45" align="right" style="padding-right:10px; background-color: #69F">
              <a href="login.php?action=vyhod" style="color:#FF0; text-decoration:none;">Выход</a></td>
          </tr>
        </table>
      </td>
    </tr>
